...
const WEBHOOK_URL = process.env.NEXT_PUBLIC_WEBHOOK_URL || 'https://your-webhook-url.com/calendar';
...
export default async function handler(
  ...
  try {
    ...
    // For demonstration purposes, if the webhook URL is not set,
    // return mock response instead of making an actual API call
    if (WEBHOOK_URL === 'https://your-webhook-url.com/calendar') {
